...
const VueTailwindSettings = {
  't-button': {
    component: TButton,
    props    : {
      fixedClasses: 'flex items-center justify-center px-4 py-1 rounded font-semibold text-sm font-sans shadow-sm transition duration-200 ease-in-out focus:outline-none focus:ring disabled:pointer-events-none disabled:cursor-default disabled:opacity-60',
      classes     : 'text-white bg-gray-800 hover:bg-gray-900 focus:ring-gray-400',
      variants    : {
        white : 'text-gray-800 bg-white hover:bg-light-400 focus:ring-gray-300',
        indigo: 'text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-indigo-300',
        blue  : 'text-white bg-blue-500 hover:bg-blue-600 focus:ring-blue-300',
  ...
  't-alert': {
    ...
    props    : {
      fixedClasses: {
        ...
        body     : 'flex-grow',
        close    : 'absolute relative flex items-center justify-center ml-4 flex-shrink-0 w-6 h-6 transition duration-100 ease-in-out rounded focus:outline-none focus:ring focus:ring-opacity-50',
        closeIcon: 'fill-current h-4 w-4',
      },
      classes: {
        wrapper: 'bg-indigo-50 border-indigo-500',
        body   : 'text-indigo-700',
        close  : 'text-indigo-500 hover:bg-indigo-200 focus:ring-indigo-500',
      },
      variants: {
        warn: {
          wrapper: 'bg-orange-50 border-orange-500',
          body   : 'text-orange-700',
          close  : 'text-orange-500 hover:bg-orange-200 focus:ring-orange-500',
        },
        danger: {
          wrapper: 'bg-red-50 border-red-500',
          body   : 'text-red-700',
          close  : 'text-red-500 hover:bg-red-200 focus:ring-red-500',
        },
        success: {
          wrapper: 'bg-green-50 border-green-500',
          body   : 'text-green-700',
          close  : 'text-green-500 hover:bg-green-200 focus:ring-green-500',
        },
      },
    },
  },
